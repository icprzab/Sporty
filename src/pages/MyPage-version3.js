            ...
            .then(response => {
                if (response) {
                    ...
                    if (!response.data().name) {
                        ...
                        setDoc(addCollect, { post: e.id, Name: e.Name, avatar: e.avatar, content: e.content, like: e.like, type: e.type, createAt: e.createAt, picture: e.picture, pictureName: e.pictureName, uid: e.uid, commentNumber: e.commentNumber, collect: "已收藏" })
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(q2, (snapshot) => {
            ...
            for (let i = 0; i <= postInfo.length - 1; i++) {
                ...
                getDoc(getLike)
                    .then(response => {
                        likePost.push({ ...postInfo[i], likeName: response.data().Name, order: i })
                        setPosts(likePost)
                    })
            }
        })
                    ...
                    <div className={myNavbar ? "middle_head active" : "middle_head"}>
                        <div className={styles.head}>
                            <div className={styles.head_content}>
                                ...
                                <div className={styles.head_content_text2} onClick={mypost}>我的貼文</div>
                                <div className={styles.head_content_text3} onClick={collect}>收藏貼文</div>
                                        ...
                                        <div className={styles.title_content}>
                                            ...
                                            <div className={styles.title_content_right}>
                                                <div className={styles.title_content_post} onClick={mypost}>
                                                    <div className={styles.title_content_post_inside}>我的</div>
                                                    <div className={styles.title_content_post_inside}>貼文</div>
                                                </div>
                                                <div className={styles.title_content_collection} onClick={collect}>
                                                    <div className={styles.title_content_post_inside}>收藏</div>
                                                    <div className={styles.title_content_post_inside}>貼文</div>
                                                </div>
                                                    ...
                                                    <div className={styles.under_left_message}>
                                                        <div className={styles.under_left_icons}>
                                                            <div className={styles.under_left_icons_like} onClick={() => ThumbUp(post)}>
                                                                <img src={post.likeName ? like : unlike}></img>
