...
import styles from "../../styles/outdoor.module.css";
        ...
        <div className={styles.category_outside}>
            <Scrollbars style={{ width: "100%", height: "100vh" }}>
                <div className={styles.category}>
                    ...
                    {outdoor_all.map(outdoor => <div className={styles.category_content_group_outside} key={outdoor.name}>
                        <div className={styles.category_content_group}>
                            <div className={styles.category_content_group_image}>
                                <img src={outdoor.images} />
                            </div>
                            <div className={styles.category_content_group_text}>
                                <div className={styles.category_content_group_sport}>{outdoor.name}</div>
                                <div className={styles.category_content_group_type}>&emsp;/ {outdoor.type} &emsp;</div>
                            </div>
                        </div>
