        ...
        <div className={styles.category_outside}>
            <Scrollbars style={{ width: "100%", height: "100vh" }}>
                <div className={styles.category}>
                    ...
                    {fitness_all.map(fitness => <div className={styles.category_content_group_outside} key={fitness.name}>
                        <div className={styles.category_content_group}>
                            <div className={styles.category_content_group_image}>
                                <img src={fitness.images} />
                            </div>
                            <div className={styles.category_content_group_text}>
                                <div className={styles.category_content_group_sport}>{fitness.name}</div>
                                <div className={styles.category_content_group_type}>&emsp;/ {fitness.type} &emsp;</div>
                            </div>
                        </div>
